...
contract ClassicHodlFactory is ERC721Full {
    ...
    address public testingVariableX;
    ...
    function buyHodl() public {
        ...
        // uint _cTokenBalanceBefore = cToken.balanceOf(address(this)); // scales it up to atto cDai
